...
<html lang="en">
  <head>
    ...
    <title>Aplikas Inventaris Buku </title>
  </head>
  <body style>
    <div class="container">
      <div class="row">
        <div class="col-md-12 mt-5">
          <h1 class="text-center">Aplikasi Inventaris Buku </h1>
          <hr style="height: 1px;color: black;background-color: black;">
        </div>
      </div>
      <div class="row">
        <div class="col-md-12"><a href="add.php" class="btn btn-primary">Tambah Buku</a>
          ...
          <div class="col-md-12"><a href="list.php" class="btn btn-primary">List buku</a>
        </div>
      </div>
    </div>
</body>
